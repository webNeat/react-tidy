...
describe('createAsync', () => {
  ...
  it(`runs the async functions and sets the data and timestamp when it resolves`, async () => {
    let hook: any
    act(() => {
  ...
  it(`runs the async functions and sets the error and timestamp when it rejects`, async () => {
    let hook: any
    act(() => {
